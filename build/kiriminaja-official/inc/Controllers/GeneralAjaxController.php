...
class GeneralAjaxController{
    public function register(){
       ...
       add_action('wp_ajax_kiriof_get_destination_area', array($this,'kj_getDestinationArea') );
       add_action('wp_ajax_nopriv_kiriof_get_destination_area', array($this,'kj_getDestinationArea') );
       add_action('wp_ajax_kiriof_get_data_after_update_checkout', array($this,'kj_getDataAfterUpdateCheckout'));
       add_action('wp_ajax_nopriv_kiriof_get_data_after_update_checkout', array($this,'kj_getDataAfterUpdateCheckout'));
    ...
    function kj_getDestinationArea(){
        ...
        WC()->session->set( 'kj_payment_method', $payment );
        WC()->session->set( 'kj_insurance', $insurance );
