				...
				<li>
					<div class="order-list-header">
						<div class="order-number">
							...
							<div class="order-ref-id"><?php echo esc_html( $this->helper->get_order_ref_id( $order_id ) ); ?></div>
						</div>
	...
	public function load_pickup_detail() {
		...
		foreach ( $order_ids as $order_id ) {
			...
			<li>
				<div class="order-list-header">
					<div class="order-number">
						<a class="order-id" href="<?php echo get_edit_post_link( $order_id ); ?>" target="_blank">#<?php echo esc_html( $order_id ); ?></a>
						<div class="order-ref-id"><?php echo esc_html( $this->helper->get_order_ref_id( $order_id ) ); ?></div>
					</div>
					<div class="order-shipping">
						<?php echo esc_html( $order->get_shipping_method() ); ?>
