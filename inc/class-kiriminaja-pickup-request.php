                ...
                <div class="kiriminaja-request-pickup-detail">
                    <div class="pickup-detail">
                        ...
                        <div class="detail-actions">
                            <button type="button" class="button button-primary ka-detail-pay"
                                    data-code=""><?php esc_html_e('Pay', 'kiriminaja') ?></button>
                ...
                <div class="kiriminaja-request-pickup">
                    <div class="pickup-time-wrapper">
                        ...
                        <button type="button" class="button button-primary"
                                id="kiriminaja-send-reschedule-pickup"><?php esc_html_e('Pick Schedule', 'kiriminaja') ?></button>
                    </div>
                </div>
            </div>
            <div id="kiriminaja-payment" style="display:none;width:300px;">
                <div class="kiriminaja-payment">
                    ...
                    <div class="text-center">
                        <button type="button" class="button button-primary"
                                id="kiriminaja-reload"><?php esc_html_e('OK', 'kiriminaja') ?></button>
                    </div>
                </div>
            </div>
            <?php
