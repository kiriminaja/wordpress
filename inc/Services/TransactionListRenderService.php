    ...
    public function render(): void {
		...
		$kiriof_transactions_bootstrap = array(
			...
			'i18n'         => array(
				...
				'copyKaOrderId' => __( 'Copy KA Order ID', 'kiriminaja-official' ),
