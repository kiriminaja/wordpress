...
class UpdateCheckService extends BaseService{
    ...
    public function call(){
        ...
        try {
            ...
            $latestVersion = str_replace('pre-release-v','',(@json_decode($response)->version ?? '0.0.0')) ;
    ...
    protected function callInfoJson(){
        ...
        curl_setopt($curl_handle, CURLOPT_URL,'https://storage.googleapis.com/tprt0ezsggqjornc7nf1wwluvgulhr/wp/woocommerce.json');
