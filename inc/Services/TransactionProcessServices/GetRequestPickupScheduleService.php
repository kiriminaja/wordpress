...
class GetRequestPickupScheduleService extends BaseService {
    ...
    /**
     * Return only the local transaction summary. Pickup times are generated by
     * the admin UI and must not depend on the remote schedules endpoint.
     */
    public function summary() {
        return self::success(
            array( 'transaction_summary' => self::transactionSummaryData() ),
            'success'
        );
    }
