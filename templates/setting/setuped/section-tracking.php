...
<div class="wrap kj-wrap">
    ...
    <div class="kj-detail">
        ...
        <div class="kj-account-card" style="background:#fff;border:1px solid #c3c4c7;border-radius:12px;padding:20px;margin-bottom:20px;box-shadow:0 1px 2px rgba(0,0,0,0.03);">
            <div style="font-size:14px;font-weight:600;color:#1d2327;margin-bottom:12px;"><?php echo esc_html( __( 'How to Add a Tracking Page', 'kiriminaja-official' ) ); ?></div>
            <ol style="margin:0;padding-left:18px;font-size:13px;color:#50575e;line-height:1.8;">
                <li><?php echo esc_html( __( 'Go to Pages › Add New in your WordPress admin.', 'kiriminaja-official' ) ); ?></li>
                <li><?php echo esc_html( __( 'Give your page a title, e.g. "Track Your Order".', 'kiriminaja-official' ) ); ?></li>
                <li><?php echo esc_html( __( 'In the content editor, add the shortcode:', 'kiriminaja-official' ) ); ?>
                ...
                <li><?php echo esc_html( __( 'Publish the page.', 'kiriminaja-official' ) ); ?></li>
                <li><?php echo esc_html( __( 'Your customers can now track their orders by visiting this page and entering their order number.', 'kiriminaja-official' ) ); ?></li>
            </ol>
        </div>
        ...
        <div class="kj-account-card" style="background:#fff;border:1px solid #c3c4c7;border-radius:12px;padding:20px;box-shadow:0 1px 2px rgba(0,0,0,0.03);">
            <div style="font-size:14px;font-weight:600;color:#1d2327;margin-bottom:12px;"><?php echo esc_html( __( 'Pages Using Tracking Shortcode', 'kiriminaja-official' ) ); ?></div>
            ...
            <?php if ( empty( $kiriof_pages ) ) : ?>
                <div style="padding:24px;text-align:center;color:#8c8f94;">
                    ...
                    <div style="font-size:14px;font-weight:500;margin-bottom:4px;"><?php echo esc_html( __( 'You haven\'t configured any tracking page yet.', 'kiriminaja-official' ) ); ?></div>
                    <div style="font-size:12px;"><?php echo esc_html( __( 'Add the shortcode [kiriminaja-tracking-front-page] to a page to enable order tracking for your customers.', 'kiriminaja-official' ) ); ?></div>
                </div>
            <?php else : ?>
                <div style="display:flex;flex-direction:column;gap:4px;">
                    ...
                    <div style="display:flex;align-items:center;justify-content:space-between;padding:10px 12px;background:#f6f7f7;border-radius:8px;">
                        ...
                        <div style="display:flex;gap:8px;">
                            <a href="<?php echo esc_url( get_permalink( $page->ID ) ); ?>" target="_blank" class="button button-small" style="font-size:12px;"><?php echo esc_html( __( 'View', 'kiriminaja-official' ) ); ?></a>
                            <a href="<?php echo esc_url( get_edit_post_link( $page->ID ) ); ?>" class="button button-small" style="font-size:12px;"><?php echo esc_html( __( 'Edit', 'kiriminaja-official' ) ); ?></a>
                        </div>
                    </div>
                    <?php endforeach; ?>
                </div>
