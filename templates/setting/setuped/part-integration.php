<span style="font-size: 18px; font-weight: 600"><?php echo kjHelper()->tlThis('Integration',@$locale); ?></span>
<div class="row-divider" style="margin-top: .5rem"></div>
<span><?php echo kjHelper()->tlThis('An integration for utilizing KiriminAja to do shipment.',@$locale); ?></span>
                ...
                <button class="button-error woocommerce-save-button kj-disconnect" type="button">
                    <div style="display: flex">
                        <div style="display: flex;align-items: center;justify-items: center;margin: auto">
                            ...
                            <span style="margin-left: 6px"><?php echo kjHelper()->tlThis('Disconnect',@$locale); ?></span>
                        </div>
                    </div>
                </button>
            </div>
