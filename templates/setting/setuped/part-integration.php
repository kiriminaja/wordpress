...
<span><?php echo esc_html( kiriof_helper()->tlThis('An integration for utilizing KiriminAja to do shipment.',$locale) ); ?></span>
    ...
    <div>
        ...
        <div class="submit-container">
            ...
            <div class="kj-btn-container">
                <button class="button action woocommerce-save-button kj-disconnect" type="button">
                    <div style="display: flex">
                        <div style="display: flex;align-items: center;justify-items: center;margin: auto">
                            ...
                            <span style="margin-left: 6px"><?php echo esc_html( kiriof_helper()->tlThis('Disconnect',$locale) ); ?></span>
                        </div>
                    </div>
                </button>
            </div>
