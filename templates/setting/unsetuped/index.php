                                                                ...
                                                                <div class="row">
                                                                        ...
                                                                        <button class="button button-primary btn-lg woocommerce-save-button kj-submit" type="button">
                                                                            <div style="display: flex">
                                                                                <div style="display: flex;align-items: center;justify-items: center;margin: auto">
                                                                                    ...
                                                                                    <span style="margin-left: 6px"><?php echo esc_html(__( 'Connect Now', 'kiriminaja-official' )); ?></span>
                                                                                </div>
                                                                            </div>
                                                                        </button>
                                                                    </div>
                                                                    <div class="col pe-md-0 ps-md-1 px-xs-0">
                                                                        <div style="position: relative">
                                                                            <button class="button-secondary btn-lg woocommerce-save-button" type="button"><?php echo esc_html( __( 'How to Connect', 'kiriminaja-official' ) ); ?></button>
