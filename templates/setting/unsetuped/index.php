                                            ...
                                            <div class="wooocommerce-task-card__header">
                                                <div class="woocommerce-task-header__contents-container">
                                                    ...
                                                    <div style="text-align: center">
                                                        ...
                                                        <div style="font-weight: 700"><?php echo kjHelper()->tlThis('Connect Wordpress to KiriminAja',@$locale); ?></div>
                                                    </div>
                                                    <div class="row-divider"></div>
                                                    <div>
                                                        <div><?php echo kjHelper()->tlThis('Connect to KiriminAja Application by Input the setup key',@$locale); ?></div>
                                                        <div style="margin-top: .5rem"></div>
                                                        <div style="font-weight: 700"><?php echo kjHelper()->tlThis('Plugin Features',@$locale); ?></div>
                                                        <div style="margin-top: .5rem"></div>
                                                        <ul class="default">
                                                            <li><?php echo kjHelper()->tlThis('Indonesian 3PL Integrations',@$locale); ?></li>
                                                            <li><?php echo kjHelper()->tlThis('Cash on Delivery Support',@$locale); ?></li>
                                                            <li><?php echo kjHelper()->tlThis('Realtime Tracking',@$locale); ?></li>
                                                        </ul>
                                                    </div>
                                                    ...
                                                    <div id="setup-form">
                                                        ...
                                                        <div>
                                                            ...
                                                            <div style="margin-top: .5rem"></div>
                                                            <div>
                                                                <input style="width: 100%; max-width: 25rem" name="setup_key" type="text" class="input-text regular-input" placeholder="<?php echo kjHelper()->tlThis('Put your setup key here',@$locale); ?>..." value="">
                                                            </div>
                                                        </div>
                                                                ...
                                                                <div class="row">
                                                                        ...
                                                                        <button class="button-primary btn-lg woocommerce-save-button kj-submit" type="button">
                                                                            <div style="display: flex">
                                                                                <div style="display: flex;align-items: center;justify-items: center;margin: auto">
                                                                                    ...
                                                                                    <span style="margin-left: 6px"><?php echo kjHelper()->tlThis('Connect Now',@$locale); ?></span>
                                                                                </div>
                                                                            </div>
                                                                        </button>
                                                                    </div>
                                                                    <div class="col pe-md-0 ps-md-1 px-xs-0">
                                                                        <div style="position: relative">
                                                                            <button class="button-secondary btn-lg woocommerce-save-button" type="button"><?php echo kjHelper()->tlThis('How to Connect',@$locale); ?></button>
