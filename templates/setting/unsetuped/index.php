                                            ...
                                            <div class="wooocommerce-task-card__header">
                                                <div class="woocommerce-task-header__contents-container">
                                                    ...
                                                    <div style="text-align: center">
                                                        ...
                                                        <div style="font-weight: 700">Connect Wordpress to KiriminAja</div>
                                                    </div>
                                                    <div class="row-divider"></div>
                                                    <div>
                                                        <div>Connect to KiriminAja Application by Input the setup key</div>
                                                        <div style="margin-top: .5rem"></div>
                                                        <div style="font-weight: 700">Plugin Features</div>
                                                        <div style="margin-top: .5rem"></div>
                                                        <ul class="default">
                                                            <li>Indonesian 3PL Integrations </li>
                                                    ...
                                                    <div id="setup-form">
                                                        ...
                                                        <div>
                                                            ...
                                                            <div style="margin-top: .5rem"></div>
                                                            <div>
                                                                <input style="width: 100%; max-width: 25rem" name="setup_key" type="text" class="input-text regular-input" placeholder="Put your setup key here...." value="">
                                                            </div>
                                                        </div>
                                                                        ...
                                                                        <button class="button-primary btn-lg woocommerce-save-button kj-submit" type="button">
                                                                            <div style="display: flex">
                                                                                <div style="display: flex;align-items: center;justify-items: center;margin: auto">
                                                                                    ...
                                                                                    <span style="margin-left: 6px">Connect Now</span>
                                                                                </div>
                                                                            </div>
                                                                        </button>
                                                                    </div>
