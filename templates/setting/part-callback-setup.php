    ...
    <table class="form-table">
        ...
        <tr valign="top">
            ...
            <td class="forminp forminp-text">
                <input style="width: 100%; max-width: 25rem" name="link_callback" type="text" class="input-text regular-input" value="" >
            </td>
        </tr>
        </tbody>
    </table>
...
<div class="kj-form-err kj-hidden" style="position: relative" onclick="fetchCallbackData()">
