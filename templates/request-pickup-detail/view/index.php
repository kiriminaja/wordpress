                                ...
                                <table class="wp-list-table widefat fixed striped table-view-list posts">
                                    ...
                                    <tr>
                                        ...
                                        <td class="manage-column column-thumb" style="white-space:nowrap">
                                            <?php if ( ! empty( $kiriof_txn->awb ) ) : ?>
                                            <a href="<?php echo esc_url( $kiriof_print_resi_url ); ?>" target="_blank" class="button" title="<?php esc_attr_e('Print','kiriminaja-official'); ?>" aria-label="<?php esc_attr_e('Print','kiriminaja-official'); ?>" style="padding:4px;width:32px;height:32px;border:none;box-shadow:none;border-radius:4px"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24"><path d="M0 0h24v24H0z" fill="none"/><path fill="currentColor" d="M18 7H6V3h12zm0 5.5q.425 0 .713-.288T19 11.5t-.288-.712T18 10.5t-.712.288T17 11.5t.288.713t.712.287M16 19v-4H8v4zm2 2H6v-4H2v-6q0-1.275.875-2.137T5 8h14q1.275 0 2.138.863T22 11v6h-4z"/></svg></a>
                                            <?php endif; ?>
                                            <a href="<?php echo esc_url( $kiriof_order_edit_url ); ?>" target="_blank" class="button" title="<?php esc_attr_e('Detail','kiriminaja-official'); ?>" aria-label="<?php esc_attr_e('Detail','kiriminaja-official'); ?>" style="padding:4px;width:32px;height:32px;border:none;box-shadow:none;border-radius:4px"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24"><path d="M0 0h24v24H0z" fill="none"/><path fill="currentColor" d="M15.188 14.688Q16.5 13.375 16.5 11.5t-1.312-3.187T12 7T8.813 8.313T7.5 11.5t1.313 3.188T12 16t3.188-1.312m-5.1-1.276Q9.3 12.625 9.3 11.5t.788-1.912T12 8.8t1.913.788t.787 1.912t-.787 1.913T12 14.2t-1.912-.787m-4.738 3.55Q2.35 14.925 1 11.5q1.35-3.425 4.35-5.462T12 4t6.65 2.038T23 11.5q-1.35 3.425-4.35 5.463T12 19t-6.65-2.037"/></svg></a>
                                        </td>
                                    </tr>
                                    <?php
                                        endforeach;
