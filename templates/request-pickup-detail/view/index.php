                                    ...
                                    <a href="<?php echo esc_url( $kiriof_print_all_url ); ?>" target="_blank" class="button button-primary" style="border-radius: 4px;">
                                        <div style="display: flex">
                                            <div style="display: flex;align-items: center;justify-items: center;margin: auto">
                                                ...
                                                <span style="margin-left: 6px"><?php esc_html_e( 'Print All', 'kiriminaja-official' ); ?></span>
                                            </div>
                                        </div>
                                    </a>
                                    <?php endif; ?>
...
<?php include dirname( dirname( __DIR__ ) ) . '/request-pickup/view/modal-payment.php'; ?>
...
<?php ob_start(); ?>
    ...
    jQuery(document).ready(function() {
        const pickupNumberToLoad = kiriofDetailUrlParams.get('pickup_number');
