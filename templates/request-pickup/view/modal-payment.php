<div id="payment-modal" class="kj-hidden">
    <div tabindex="0" class="media-modal" role="dialog">
        <div class="media-modal-container">
            <div class="closebtn-container" onclick="document.getElementById('payment-modal').classList.add('kj-hidden');">
            ...
            <div class="content-body">
                ...
                <div class="kj-modal-content kj-hidden">
                    <div style="display: flex; margin: 2rem 0">
                        <div style="margin: auto" id="paymentQR"></div>
                    </div>
                    <div style="text-align: center">
                        <div style="font-weight: 400; margin-bottom: 1rem">QR berlaku sebelum</div>
                        <div style="font-size: 2rem; font-weight: 400">20:01</div>
                    </div>
                </div>
