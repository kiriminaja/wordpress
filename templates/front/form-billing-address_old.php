...
<div id="kj-expedition-inquiry" class="kj-hidden ">
    ...
    <p class="form-row form-row-wide">
        ...
        <select name="kj_destination_area" id="kj_destination_area" class="custom_select_field" style="width: 100%;" required></select>
    </p>
    <!--Insurance Field-->
    <p class="form-row form-row-wide">
...
<script type="text/javascript">
    ...
    let subDistrictSelectElem = jQuery(`[name="kj_destination_area"]`);
    let subDistrictSelectElemSearchFieldId = 'kj_destination_area_search';
