...
<div class="kj-cart-total cart_totals <?php echo ( WC()->customer->has_calculated_shipping() ) ? 'calculated_shipping' : ''; ?>">
    ...
    <div class="kj-judul">
        <p><?php esc_html_e( 'Cart totals', 'kiriminaja-official' ); ?></p>
    </div>
	...
	foreach ( WC()->cart->get_coupons() as $code => $coupon ) : ?>
		...
		<?php elseif ( WC()->cart->needs_shipping() && 'yes' === get_option( 'woocommerce_enable_shipping_calc' ) ) : ?>
			...
			<tr class="shipping">
				<th><?php esc_html_e( 'Shipping', 'kiriminaja-official' ); ?></th>
	...
	$estimated_text  = '';
		...
		<tr class="order-total">
			...
			<td data-title="<?php esc_attr_e( 'Total', 'kiriminaja-official' ); ?>"><?php wc_cart_totals_order_total_html(); ?></td>
		</tr>
