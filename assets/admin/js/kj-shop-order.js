jQuery(document).ready(function(){
    ...
    jQuery(document).ajaxSuccess(function(event, xhr, settings) {
        ...
        if(
            ...
            if( shippingMethodElement.val() == 'kiriminaja' ){
                ...
                setTimeout(() => {
                    ...
                    console.log($('[name="kj_expedition"] option'));
        ...
        // if (
        //     settings.data && settings.data.indexOf('action=woocommerce_save_order_items') !== -1 || //save order
        //     settings.data && settings.data.indexOf('action=woocommerce_calc_line_taxes') !== -1 //auto load expedition selected
        // ) {
